...
4. Univariate and multivariate time series models for forecasting and econometric analysis.
4. Evaluate different forecasting models and assess which model provides the best fit.
