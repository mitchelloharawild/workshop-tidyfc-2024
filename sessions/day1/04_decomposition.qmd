...
```{=html}
<embed src="../../materials/04_decomposition.pdf" type="application/pdf" width="750px" height="420px">
```

[View slides in full screen](../../materials/04_decomposition.pdf)
