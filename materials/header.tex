% Fix LaTeX bug (https://github.com/quarto-dev/quarto-cli/issues/10019)
...
{\placefig{-0.01}{-0.01}{width=1.01\paperwidth,height=1.01\paperheight}{background.jpg}
\begin{textblock}{8}(7.5,2)
  \raggedleft\fontsize{20}{20}\selectfont\bfseries\sffamily\textcolor{white}{\inserttitle}\\[0.2cm]
  \fontsize{12}{12}\selectfont\bfseries\sffamily\textcolor{white}{\insertsubtitle}
  \end{textblock}
\placefig{8}{6}{width=2.4cm}{tsibble.png}
\placefig{10.4}{6}{width=2.4cm}{feasts.png}
\placefig{12.8}{6}{width=2.4cm}{fable.png}
\begin{textblock}{7.5}(10.6,-.1)
  {\fontsize{9}{9}\sf\color{white}workshop.nectric.com.au/tidyfc2024}
\end{textblock}
}
