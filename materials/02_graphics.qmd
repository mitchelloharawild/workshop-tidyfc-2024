...
```{r students}
students <- readxl::read_excel("https://www.abs.gov.au/statistics/people/education/schools/2023/Table 42b Number of Full-time and Part-time Students - 2006-2023.xlsx", sheet = 3, skip = 4) |> 
  group_by(Year, State = substring(`State/Territory`, 3)) |> 
  summarise(Count = sum(`All Full-time and Part-time Student count`), .groups = "drop") |> 
...
Calculate the difference in ACT student enrolments, it can be done as follows:
